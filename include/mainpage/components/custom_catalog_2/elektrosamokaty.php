...
<? $APPLICATION->IncludeComponent(
	...
	array(
		...
		"TITLE" => "Выбери себе нового друга",
		...
		"IMG_CORNER" => "Y",
		"ELEMENT_IN_ROW" => "5",
		"COUNT_ROWS" => "SHOW_MORE",
		"TABS_FILTER" => "SECTION",
		"BORDERED" => "Y",
		"ELEMENTS_SOURCE" => "SHOW_ON_INDEX_PAGE",
		"CUSTOM_FILTER" => "{\"CLASS_ID\":\"CondGroup\",\"DATA\":{\"All\":\"OR\",\"True\":\"True\"},\"CHILDREN\":[{\"CLASS_ID\":\"CondIBSection\",\"DATA\":{\"logic\":\"Equal\",\"value\":188}},{\"CLASS_ID\":\"CondIBSection\",\"DATA\":{\"logic\":\"Equal\",\"value\":187}}]}",
		"SHOW_TABS" => "N",
		"PAGE_ELEMENT_COUNT" => ""
	),
	false
