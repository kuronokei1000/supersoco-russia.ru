...
$APPLICATION->SetTitle("Договор-оферта интернет-магазина");?><h3>Основные понятия:</h3>
<ul>
	<li><b>Посетитель Сайта</b> — лицо, пришедшее на сайт <a href="http://вашсайт.ru">http://вашсайт.ru</a> без цели размещения Заказа.</li>
	<li><b>Пользователь</b> — физическое лицо, посетитель Сайта, принимающий условия настоящего Соглашения и желающий разместить Заказы в Интернет-магазине &lt;КОМПАНИЯ&gt;.</li>
	...
	<li><b>Продавец</b> — &lt;КОМПАНИЯ&gt; (&lt;РЕКВИЗИТЫ КОМПАНИИ&gt;), место нахождения 000000, г. &lt;ГОРОД&gt;, ул. &lt;УЛИЦА&gt;, д. &lt;ДОМ&gt;, офис &lt;ОФИС&gt;</li>
...
<p>
	 1.10. Условия осуществления доставки и возврата доступны на сайте <a href="http://вашсайт.ru">http://вашсайт.ru</a> в разделах <a href="<?=SITE_DIR?>help/delivery/">«Доставка»</a> и <a href="<?=SITE_DIR?>help/warranty/">«Возврат»</a>.
</p>
<p>
...
<p>
	 3.5. Заказ Покупателя оформляется в соответствии с процедурами, указанными на Сайте в разделе <a href="<?=SITE_DIR?>order/">«Оформление заказа»</a>.
</p>
<p>
...
<p>
	 4.1. Способы, а также примерные сроки доставки Товаров, реализуемых Продавцом, указаны на Сайте в разделе <a href="<?=SITE_DIR?>help/delivery/">«Доставка»</a>. Конкретные сроки доставки могут быть согласованы Покупателем при подтверждении заказа.
</p>
<p>
...
<p>5.3. Произвести оплату Покупатель может способами, указанными в разделах сайта <a href="<?=SITE_DIR?>help/payment/">«Оплата»</a> и <a href="<?=SITE_DIR?>help/delivery/">«Доставка»</a>.</p>
...
<p>5.10 Продавец вправе ограничивать доступные Покупателю способы оплаты в зависимости от объёма предыдущих заказов.</p>
<h3>6. Возврат и обмен товара и денежных средств</h3>
<p>6.1.1 Возврат Товара, реализуемого Продавцом, осуществляется в соответствии со следующими условиями возврата.</p>
<p>6.1.2. Обмен Товара, если он не подошел Покупателю по форме, габаритам, фасону, расцветке, размеру или комплектации возможен в срок обмена — 14 дней, не считая дня покупки.</p>
<p>6.1.3. Возврат или обмен товара возможны, когда: сохранены его товарный вид (упаковка, пломбы, ярлыки), потребительские свойства, сохранена комплектность товара, а также документ, подтверждающий факт и условия покупки указанного товара (товарный или кассовый чек).</p>
...
<h3>10. Дополнительные условия</h3>
	 ...
	 10.5. Признание судом недействительности какого-либо положения настоящей Публичной оферты не влечет за собой недействительность остальных положений.<?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>