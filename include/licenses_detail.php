...
<h2>Политика в отношении персональных данных</h2>
...
<div class="mx-4">
    <p>
        ...
        Соболевым Игорем Петровичем (далее — Оператор).
    </p>
    <p>
...
<div class="mx-4">
    ...
    <p>
        ...
        определяемому Пользователю веб-сайта <a
                href="https://supersoco-russia.ru/">https://supersoco-russia.ru</a>.<br>
        ...
        предусмотренном
        Законом о персональных данных (далее — персональные данные, разрешенные для распространения).<br>
...
<p>
    ...
    предусмотренных федеральными законами. Сведения предоставляются субъекту персональных данных Оператором в доступной
    ...
    персональных данных без согласия последнего, несут ответственность в соответствии с законодательством РФ.<br>
    <br>
    <br>
</p>
<p>
...
<table border="1" cellpadding="0">
    ...
    <tr>
        ...
        <td>
            <ul type="disc">
                <li>Федеральный закон "Об информации, информационных технологиях и о защите информации" от
                    27.07.2006 N
                    149-ФЗ
                </li>
            </ul>
...
<p>
    ...
    путем направления Оператору уведомление на адрес электронной почты Оператора <a
            href="mailto:info@supersoco-russia.ru">info@supersoco-russia.ru</a> с пометкой «Актуализация
    персональных данных».<br>
    ...
    Оператору уведомление посредством электронной почты на электронный адрес Оператора <a
            href="mailto:info@supersoco-russia.ru">info@supersoco-russia.ru</a> с пометкой «Отзыв согласия на обработку
    персональных данных».<br>
...
<p>
    ...
    персональных данных, обратившись к Оператору с помощью электронной почты <a
            href="mailto:info@supersoco-russia.ru"
            title="Ссылка: mailto:info@supersoco-russia.ru">info@supersoco-russia.ru</a>.<br>
    ...
    по адресу <a
            href="https://supersoco-russia.ru/include/licenses_detail.php">https://supersoco-russia.ru/include/licenses_detail.php</a>.
</p>
<p>
