...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<style type="text/css">
			...
			/* custom */
			.mail-body-title .bxBlockPadding {
				padding-top: 0px;
			}
			.mail-contacts {
											...
											<tbody>
												<tr>
													<td data-bx-block-editor-place="footer">
														<div data-bx-block-editor-block-type="text">
															<table border="0" cellpadding="0" cellspacing="0" width="100%" class="bxBlockText mail-block mail-contacts">
															<tbody class="bxBlockOut">
																<tr>
																	<td valign="top" class="bxBlockInn bxBlockInnText">
																		<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
																		<tbody>
																			<tr>
																				<td valign="top" class="bxBlockPadding bxBlockContentText">
																					<p style="text-align: left;"><?=Loc::getMessage('CONTACTS_TEXT', array('#SITE_ADDRESS#' => $siteAddressFull))?></p>
																					<p style="text-align: left;">
																						<?if (
																							strlen($emailHtml) ||
																							strlen($phoneHtml)
																						):?>
																							<span><?=implode('&nbsp;&nbsp;&nbsp;&nbsp;', [$emailHtml, $phoneHtml])?></span>
																						<?endif;?>
																					</p>
																				</td>
																			</tr>
