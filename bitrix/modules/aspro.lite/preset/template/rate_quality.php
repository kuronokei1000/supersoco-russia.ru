								...
								<tr>
									<td valign="top" class="bxBlockPadding bxBlockInn bxBlockInnButton">
										...
										<tbody>
											<tr>
												<td valign="top">
													<a class="bxBlockContentButton" title="<?=htmlspecialcharsbx(Loc::getMessage('MAIL_TEXT_BUTTON'))?>" href="/company/reviews/" target="_blank" style="background:inherit"><?=Loc::getMessage('MAIL_TEXT_BUTTON')?></a>
												</td>
											</tr>
										</tbody>
										</table>
