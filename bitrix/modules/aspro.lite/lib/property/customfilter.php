...
class CustomFilter{
	static function OnIBlockPropertyBuildList(){
		return array(
			...
			'DESCRIPTION' => Loc::getMessage('LITE_CUSTOM_FILTER_PROP_TITLE'),
	...
	static function getJSFile() {
		return '/bitrix/js/aspro.lite/property/customfilter_control.js';
	}

	static function getAjaxFile() {
		return '/bitrix/tools/aspro.lite/customfilter_ajax.php';
	}
								...
								'if(iv){'.
									...
									'if(td){'.
										...
										'if(tdd){'.
											...
											'}'.
										'}'.
										'initAsproLiteCustomFilterControl({'.
