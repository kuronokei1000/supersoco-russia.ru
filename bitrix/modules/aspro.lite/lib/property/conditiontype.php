...
class ConditionType{
	static function OnIBlockPropertyBuildList(){
		return array(
			'PROPERTY_TYPE' => 'L',
			'USER_TYPE' => 'SAsproModalConditionsTypeLite',
			'DESCRIPTION' => Loc::getMessage('LITE_MODAL_CONDITIONS_TYPES_PROP_TITLE'),
	...
	private static function addCss($arProperty){
		$GLOBALS['APPLICATION']->SetAdditionalCss('/bitrix/css/aspro.lite/property/conditiontype.css');
	}
	...
	private static function addJs($arProperty, $dependProps){
		...
		$GLOBALS['APPLICATION']->AddHeadScript('/bitrix/js/aspro.lite/property/conditiontype.js');
	}
}
