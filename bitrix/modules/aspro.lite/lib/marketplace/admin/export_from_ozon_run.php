...
$INTERNAL_VARS_LIST = 'intMaxSectionID,boolNeedRootSection,arSectionIDs,arAvailGroups,curVendoreProp,USE_PRICES_WITH_DISCOUNT,NEED_UPLOAD_STORES,NEED_UPLOAD_PRICES,NEED_UPLOAD_PRODUCTS,stage';
...
use Aspro\Lite\Marketplace\Run\Export_ozon\Main as Run;

$run = new Run($IBLOCK_ID, $CLIENT_ID);
...
$run->setOptions([
    ...
    'lastId' => $CUR_ELEMENT_ID,
    'stage' => $stage,
    'profileId' => $PROFILE_ID,
    'strActFileName' => $strActFileName,
