...
class Helper
{
    ...
    static public function getSkuInfo($iblockId)
    {
        if (ConfigBase::isCatalogModule()) {
            return \CCatalogSku::GetInfoByIBlock($iblockId);
        }
        return false;
    }

    static public function isOffer($element)
    {
        return $element['TYPE'] === \Bitrix\Catalog\ProductTable::TYPE_OFFER;
    }
}