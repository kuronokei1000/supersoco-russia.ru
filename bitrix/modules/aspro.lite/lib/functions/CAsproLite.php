...
if (!class_exists("CAsproLite")) {
	class CAsproLite
	{
		...
		{
			$arPlacemarks = $arFormatShops = array();
			$mapLAT = $mapLON = 0;
		...
		*/
		...
		{
			$sefUrl = is_array($arOptions) ? $arOptions['SEF_URL'] : $arOptions;
			if ($sefUrl) {
				global $APPLICATION;
				$arParseStr = [];
		...
		public static function replacePropsParams(&$arParams, $arReplaceCode = ['PROPERTY_CODE' => 'LIST_PROPERTY_CODE'])
		{
			...
			$arParams["SKU_SORT_FIELD"] = Solution::GetFrontParametrValue('CATALOG_SKU_SORT_FIELD');
			$arParams["SKU_SORT_ORDER"] = Solution::GetFrontParametrValue('CATALOG_SKU_SORT_ORDER');
			$arParams["SKU_SORT_FIELD2"] = Solution::GetFrontParametrValue('CATALOG_SKU_SORT_FIELD2');
			$arParams["SKU_SORT_ORDER2"] = Solution::GetFrontParametrValue('CATALOG_SKU_SORT_ORDER2');
		}
	}
}?>