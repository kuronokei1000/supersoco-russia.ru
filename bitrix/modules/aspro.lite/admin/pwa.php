...
<?if($RIGHT >= 'R'):?>
				...
				foreach(PWA::getParams() as $blockCode => $arBlock){
					...
					foreach($arBlock['OPTIONS'] as $optionCode => $arOption){
						...
						elseif($optionType === 'file'){
							...
							$newVal = unserialize(Option::get($moduleID, $optionCode, $arValueDefault, $optionsSiteID), ['allowed_classes' => false]);
	...
	<?if(!count($arTabs)):?>
		<div class="adm-info-message-wrap adm-info-message-red">
			<div class="adm-info-message">
				<div class="adm-info-message-title"><?=GetMessage('ASPRO_LITE_NO_SITE_INSTALLED', array('#SESSION_ID#' => bitrix_sessid_get()))?></div>
	...
	<?endif;?>
<?else:?>
	<?=CAdminMessage::ShowMessage(GetMessage('ASPRO_LITE_NO_RIGHTS_FOR_VIEWING'));?>
<?endif;?>
