if (typeof window.JxPopover === 'undefined') {
	...
	window.JxPopover.prototype = {
		...
		bindEvents: function() {		
			...
			if (window.JxPopover.isTouch()) {
				...
				BX.bind(this.node, 'touchmove', BX.proxy(this.handlers.onTouchMove, this));
	...
	window.JxPopover.bindEvents = function() {
		if (typeof window.JxPopover.handlers.onToggleNodeClick === 'function') {
			BX.bindDelegate(document, 'click', {className: 'xpopover-toggle'}, window.JxPopover.handlers.onToggleNodeClick);
		}

		if (!window.JxPopover.isTouch()) {
			if (typeof window.JxPopover.handlers.onDocOver === 'function') {
				BX.bind(document, 'mouseover', window.JxPopover.handlers.onDocOver);
			}
		}

		if (typeof window.JxPopover.handlers.onDocClick === 'function') {
			BX.bind(document, 'click', window.JxPopover.handlers.onDocClick);
		}

		if (typeof window.JxPopover.handlers.onOverlayClick === 'function') {
			BX.bindDelegate(document, 'click', {className: 'xpopover-overlay'}, window.JxPopover.handlers.onOverlayClick);
		}
