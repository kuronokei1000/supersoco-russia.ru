...
<div class="flexbox">
	<div class="form popup<?=($arResult['FORM_NOTE'] ? ' success' : '')?><?=($arResult['isFormErrors'] == 'Y' ? ' error' : '')?>">
		...
		<?if(!$arResult["FORM_NOTE"]){?>
			...
			<div class="form-footer">
				<div>
					<input type="submit" onclick="ym(96743457,'reachGoal','zakaz'); return true;" class="btn btn-default btn-lg btn-wide" value="<?=$arResult["arForm"]["BUTTON"]?>" name="web_form_submit">
				</div>
