...
$MESS["REGISTER_EMAIL_WILL_BE_SENT"] = "На указанную в форме электронную почту придет запрос на подтверждение регистрации.";
...
$MESS["EMAIL_DESCRIPTION"] = "Если вы укажете свою электронную почту, то это существенно ускорит обработку заказа.<br>Пожалуйста, проверяйте свою почту чаще!";
