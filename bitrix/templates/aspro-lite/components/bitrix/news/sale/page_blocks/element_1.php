...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"FORM_ID_ORDER_SERVISE" => ($arParams["FORM_ID_ORDER_SERVISE"] ? $arParams["FORM_ID_ORDER_SERVISE"] : "aspro_lite_order_services"),
		...
		"SALE_IBLOCK_ID" => ($arParams["SALE_IBLOCK_ID"] ? $arParams["SALE_IBLOCK_ID"] : TSolution\Cache::$arIBlocks[SITE_ID]["aspro_lite_content"]["aspro_lite_sales"][0]),
		...
		"DETAIL_BLOCKS_ORDER" => ($arParams["DETAIL_BLOCKS_ORDER"] ? $arParams["DETAIL_BLOCKS_ORDER"] : 'tabs,big_gallery,services,sale,articles,licenses,goods,comments'),
		...
		"DETAIL_BLOCKS_ALL_ORDER" => ($arParams["DETAIL_BLOCKS_ALL_ORDER"] ? $arParams["DETAIL_BLOCKS_ALL_ORDER"] : 'desc,char,reviews,big_gallery,video,services,sale,articles,docs,licenses,goods,custom_tab,comments'),
