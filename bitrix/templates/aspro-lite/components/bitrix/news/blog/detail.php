...
<?else:?>
    ...
    <?php
    // 04.07.2024 [Roman Brovin] Изменил itemtype="http://schema.org/Service на itemtype="http://schema.org/Article
    ?>
	<div class="detail detail-maxwidth <?=($templateName = $component->{'__template'}->{'__name'})?>" itemscope itemtype="http://schema.org/Article">
