			...
			<div class="basket-checkout-section-inner">
				...
				<div class="basket-checkout-section-right">
					...
					<div class="basket-checkout-block basket-checkout-btn checkout-order">
						<button class="btn btn-lg btn-default basket-btn-checkout{{#DISABLE_CHECKOUT}} disabled{{/DISABLE_CHECKOUT}}" onclick="ym(96743457,'reachGoal','oformlenie'); return true;" data-entity="basket-checkout-button">
