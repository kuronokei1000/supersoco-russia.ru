...
$APPLICATION->AddViewContent('cowl_buttons', '<div class="basket-back font_xs"><a href="'.TSolution::GetFrontParametrValue('BASKET_PAGE_URL').'" class="basket-back__link muted">'.Loc::getMessage('GO_TO_BASKET').'</a></div>');
?>
	<NOSCRIPT>
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order-main" class="row orderform--v2 bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="col-md-9 bx-soa">
				...
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active bx bg-gray-200">
				...
				<div class="pandd">
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						...
						<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active">
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								...
								<div class="change-info btn btn-transparent-border"><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
							<div class="bx-soa-section-content container-fluid"></div>
					...
					<? else: ?>
						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active bg-gray-200" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								<h2 class="bx-soa-section-title"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?><span class="city_destination"><?=Loc::getMessage('TITLE_SOA_DESTINATION')?></span><span class="change_city font_xs colored "><?=Loc::getMessage('TITLE_SOA_CHANGE_CITY')?></span></h2>
								<div class="change-info btn btn-transparent-border"><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
						...
						<!--	PAY SYSTEMS BLOCK	-->
						<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active bg-gray-200">
							<div class="bx-soa-section-title-container bx-soa-section-title-container--flex">
								<h2 class="bx-soa-section-title"><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></h2>
								<div class="change-info btn btn-transparent-border"><?=Loc::getMessage('TITLE_SOA_CHANGE_INFO_SECTION')?></div>
							</div>
			...
			<div id="bx-soa-total" class="col-sm-3 bx-soa-sidebar">
				...
				<div class="bx-soa-total-wrapper">
					<div class="bx-soa-cart-total bg-gray-200"></div>
				</div>
			</div>
		</div>
	</form>
