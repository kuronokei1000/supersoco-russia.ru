...
<?php // 04.07.2024 [Roman Brovin] Закоментировал meta itemprop="category"?>
<!--	<meta itemprop="category" content="--><?php //=$arResult['CATEGORY_ITEM'];?><!--" />-->
<?endif;?>
...
<?if($templateData['DETAIL_TEXT'] || $templateData['PREVIEW_TEXT']):?>
    ...
    <?php // 10.07.2024 [Roman Brovin] Изменил itemprop="description" на itemprop="articleBody" ?>
