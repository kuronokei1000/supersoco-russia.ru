	...
	<div class="sections-slider <?=$templateName?>-template">
		...
		<div class="maxwidth-theme">
			<div class="swiper-nav-offset relative">
				<?/*<div class="mobile-scrolled slider-solution slider-solution--static-dots appear-block mobile-offset mobile-offset--right" data-plugin-options='<?=json_encode($arOptions)?>'>*/?>
