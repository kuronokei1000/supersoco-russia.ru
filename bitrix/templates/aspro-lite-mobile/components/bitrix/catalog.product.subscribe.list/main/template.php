...
if(!$arResult['USER_ID'] && !isset($arParams['GUEST_ACCESS'])):?>
	...
	<div class="row guest-block">
		...
		<div class="col-md-12 col-sm-12" id="catalog-subscriber-auth-form" style="<?=$authStyle?>">
			<?$APPLICATION->IncludeComponent(
				...
				Array(
					...
					"PROFILE_URL" => $arTheme['PERSONAL_PAGE_URL']['VALUE'] ?: SITE_DIR."personal/",
					"SHOW_ERRORS" => "Y",
				)
			);?>
			<hr class="bxe-light">
		...
		<div id="catalog-subscriber-identification-form" style="<?=$identificationStyle?>">
			<div class="col-md-12 col-sm-12 catalog-subscriber-identification-form form">
				<div class="form-header">
					<div class="text">
						<div class="title font_24 color_222"><?=Loc::getMessage('CPSL_HEADLINE_FORM_SEND_CODE') ?></div>
					</div>
				</div>
				<form method="post">
					<div class="form-body">
			...
			<div class="col-md-12 col-sm-12 form">
				<div class="form-header">
					<div class="text">
						<div class="title font_24 color_222"><?=Loc::getMessage('CPSL_HEADLINE_FORM_FOR_ACCESSING') ?></div>
					</div>
				</div>				
				<form method="post">
					<div class="form-body">
...
if (!empty($arResult['ITEMS']))
{
	...
	<? foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		?>
	<div class="<?=($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item');?> js-popup-block" id=
		"<?=$strMainID;?>">
...
<!--		</div>-->
	...
	<a id="<?=$arItemIDs['PICT'];?>" href="<?=$arItem['DETAIL_PAGE_URL'];?>" class=
		"bx_catalog_item_images lazyload js-popup-image"
	...
	if ($arItem['SECOND_PICT'])
	{
		?><a id="<?=$arItemIDs['SECOND_PICT'];?>" href="<?=$arItem['DETAIL_PAGE_URL'];?>" class=
			"bx_catalog_item_images_double lazyload"<? if ($arParams['SHOW_IMAGE'] == "Y")
	{
	...
	{
		?>
		<div class="bx_catalog_item_title js-popup-title">
	...
	?>
		...
		<div class="bx_catalog_item_controls touch">
			<a class="bx_bt_button_type_2 bx_medium btn btn-default" href="<?=$arItem['DETAIL_PAGE_URL'];?>"><?
