...
<? if (
    ...
    <?$GLOBALS['arSetsFilter'] = [
        'ID' => $arProductSet, 
        'ITEMS' => $templateData['CATALOG_SETS']['SET_ITEMS'],
    ];?>
    <?ob_start();?>
        <?$APPLICATION->IncludeComponent(
            ...
            array(
                ...
                "COMPATIBLE_MODE" => "Y",
                "OFFERS_FIELD_CODE" => ['ID', 'NAME', 'DETAIL_PAGE_URL'],
            ),
            false, 
            ["HIDE_ICONS" => "Y"]
        );?>
    ...
    <?if($bTab):?>
        ...
        <?endif;?>
    <?else:?>
        <div class="grid-list__item detail-block ordered-block ordered-block--hide-icons complect">
            <?if($arParams["T_COMPLECT"]):?>
