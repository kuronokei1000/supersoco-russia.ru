...
$arExtensions = ['detail', 'swiper', 'swiper_events', 'rounded_columns', 'viewed', 'hint', 'stickers', 'prices', 'stores_amount'];
$arExtensionsMobile = ['fancybox', 'fancybox.plus', 'gallery', 'counter'];
...
if (
	...
	$arExtensions[] = 'bootstrap.lite';
	$arExtensions[] = 'tabs';
	$arExtensions[] = 'tabs.history';
}
...
<div class="catalog-detail__bottom-info">
	<div class="grid-list grid-list--gap-48">
		<?
