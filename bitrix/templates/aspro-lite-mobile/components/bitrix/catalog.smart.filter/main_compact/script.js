...
if (!window.JCSmartFilterBinds) {
  ...
  appAspro.togglePropBlock = className => {
          ...
          if (this.reset === "Y") {
            if ($(control).attr("type") == "checkbox" || $(control).attr("type") == "radio") {
              if ($(control).attr("checked")) {
                ...
                $(control).next().removeClass("sku-props__value--active");
              }
            }
          }
...
JCSmartFilter.prototype.filterCatalog = function (url, set_disabled, reset, count) {
  ...
  $.ajax({
    ...
    success: function (html) {
      ...
      if (reset === "Y" /*&& (!$("#wrapInlineFilter").length || !$("#wrapInlineFilter").is(":empty"))*/) {
        ...
        if ($(html).find(".filter_title").hasClass("active-filter")) {
          ...
          $(".bx_filter_search_button").css("color", "#fff");
        } else {
          $(".filter_title").removeClass("active-filter");
          $(".bx_filter_search_reset ").addClass("hidden");
          $(".bx_filter_search_button").css("color", "#ffffdd");
        }
      }

      if (reset === "Y" && $("#mobilefilter .bx_filter").length) {
        // $("#mobilefilter").html("");
...
JCSmartFilter.prototype.resetForm = function (url) {
  const values = [{ name: "ajax", value: "y" }];
  this.form = BX.findParent(BX("del_filter"), { tag: "form" });
  this.gatherInputsValues(values, this.form.querySelectorAll("input[type=hidden]"));
...
JCSmartFilter.prototype.postHandler = function (result, fromCache, reset) {
