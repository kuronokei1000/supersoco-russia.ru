...
if($arResult["ITEMS"]){?>
	...
	<div class="filter-compact-block">
		<div class="bx_filter bx_filter_vertical compact <?=(isset($arResult['EMPTY_ITEMS']) ? 'empty-items': '');?>">
			<div class="bx_filter_section clearfix">
				<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
					
					<div class="bx_filter_parameters_box title color_222 font_12 text-upper font_bold visible-767">
