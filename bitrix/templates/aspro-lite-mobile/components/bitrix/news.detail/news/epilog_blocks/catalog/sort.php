...
$sort = !empty($_COOKIE['catalogNewsSort']) ? $_COOKIE['catalogNewsSort'] : $sort_default;
$order = !empty($_COOKIE['catalogNewsOrder']) ? $_COOKIE['catalogNewsOrder'] : $order_default;
...
$arDelUrlParams = array('sort', 'order', 'control_ajax', 'ajax_get_filter', 'linerow', 'display', 'is_aspro_mobile');
?>
<!-- noindex -->
