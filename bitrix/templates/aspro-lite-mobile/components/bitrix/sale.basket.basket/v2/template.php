...
if ($arParams['USE_GIFTS'] === 'Y') {
	...
	$giftParameters = array(
		...
		'HIDE_NOT_AVAILABLE' => (\Bitrix\Main\Config\Option::get(Solution::moduleID, 'HIDE_NOT_AVAILABLE', 'N') == 'Y') ? 'Y' : 'N',
...
$APPLICATION->AddViewContent('cowl_buttons', '<div class="basket-back font_13"><a href="' . TSolution::GetFrontParametrValue('CATALOG_PAGE_URL') . '" class="basket-back__link muted">' . Loc::getMessage('SBB_BACK_CATALOG_TITLE') . '</a></div>');
