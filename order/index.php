...
<?if (TSolution::isSaleMode()):?>
	...
	array(
		...
		"MESS_SUCCESS_PRELOAD_TEXT" => "Мы заполнили все ваши данные автоматически",
		"MESS_FAIL_PRELOAD_TEXT" => "Мы заполнили все ваши данные автоматически.<br />Обратите внимание на развернутый блок с информацией о заказе. Здесь вы можете внести необходимые изменения или оставить как есть и нажать кнопку \"#ORDER_BUTTON#\".",
